...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      no: { title: 'A normal enterprise agreement is enough', items: ['Marketing copy, internal notes, meeting summaries and general drafting', 'You are on Microsoft 365 or Google Workspace business tiers, where enterprise terms already prohibit training on your content', 'The concern is reputational rather than contractual, and a written policy would settle it', 'Fewer than about twenty regular users, where per-seat enterprise licences cost far less', 'Nobody can point at the specific clause, regulation or client requirement driving it'] },
