...
module.exports = function booking(s, SITE, u) {
  ...
  const fallback = `<div class="ai-book-fallback"><h3>The diary is being connected.</h3><p>Send a note with two or three times that suit you and we will confirm one by email within a working day.</p><a class="btn btn-purple" href="${SITE.CONTACT_URL}">Suggest a time</a></div>`;
